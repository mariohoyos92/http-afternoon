...
class Edit extends Component {
    ...
    componentWillMount(){
        axios.get(`/api/blogs/${this.props.match.params.id}`).then((response) => this.setState({
    ...
    updatePost(){
        ...
        axios.put(`/api/blogs/${this.props.match.params.id}`, body).then((results) => this.props.history.push(`/blog/${results.data.id}`)).catch(console.log)
    }

    deletePost(){
        axios.delete(`/api/blogs/${this.props.match.params.id}`).then(() =>this.props.history.push('/search')).catch(console.log)
    }
